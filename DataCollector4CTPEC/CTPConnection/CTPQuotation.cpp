...
//		tagSnapHF.Amount = pQuotationData->Turnover * refNameTable.ContractMult;
	...
	QuoCollector::GetCollector()->OnData( 125, (char*)&tagSnapLF, sizeof(tagSnapLF), true );
	QuoCollector::GetCollector()->OnData( 126, (char*)&tagSnapHF, sizeof(tagSnapHF), true );
	QuoCollector::GetCollector()->OnData( 127, (char*)&tagSnapBS, sizeof(tagSnapBS), true );
}
