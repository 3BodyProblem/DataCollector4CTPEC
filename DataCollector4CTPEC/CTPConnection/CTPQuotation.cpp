...
void CTPQuotation::FlushQuotation( CThostFtdcDepthMarketDataField* pQuotationData, bool bInitialize )
{
	...
	tagECFutureMarketStatus_HF123	tagStatus = { 0 };		///< 市场状态信息
	...
	if( (nSerial=QuoCollector::GetCollector()->OnQuery( 124, (char*)&tagName, sizeof(tagName) )) <= 0 )
	{
		return;
	}
...
//		tagSnapHF.Amount = pQuotationData->Turnover * refNameTable.ContractMult;
	...
	QuoCollector::GetCollector()->OnData( 125, (char*)&tagSnapLF, sizeof(tagSnapLF), false );
	QuoCollector::GetCollector()->OnData( 126, (char*)&tagSnapHF, sizeof(tagSnapHF), false );
	QuoCollector::GetCollector()->OnData( 127, (char*)&tagSnapBS, sizeof(tagSnapBS), false );
}
